...
<div class="container-fluid px-4">
    <div class="mb-4">
        <h1 class="h3 mb-0">Add About Content Section</h1>
    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.about.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('section_key') is-invalid @enderror" 
                                ...
                                <option value="history" {{ old('section_key') == 'history' ? 'selected' : '' }}>Company History</option>
                                <option value="values" {{ old('section_key') == 'values' ? 'selected' : '' }}>Core Values</option>
                            </select>
                            @error('section_key')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      name="content" 
                                      rows="5"
                                      placeholder="Enter main content">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content_secondary') is-invalid @enderror" 
                                      ...
                                      rows="4"
                                      placeholder="For vision or additional content (optional)">{{ old('content_secondary') }}</textarea>
                            @error('content_secondary')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Use this for Vision statement in mission section</small>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">List Items (for Values/History)</label>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <ul class="mb-0">
                        <li><strong>Hero:</strong> Use title, subtitle, and image</li>
                        <li><strong>Mission/Vision:</strong> Use content and content_secondary</li>
                        <li><strong>Values:</strong> Use items array for list</li>
                        <li><strong>History:</strong> Use items for timeline points</li>
                    </ul>
                </div>
            </div>
        </div>
